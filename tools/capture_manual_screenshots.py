    ...
    with tempfile.TemporaryDirectory(prefix="pt2vhf-manual-") as td:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                page.locator('.config-section-tab[data-config-section="aprs"]').click()
                page.wait_for_timeout(350)
                page.screenshot(path=str(output_dir / "config-aprs.png"))
                page.locator("#toggleFilterBuilderButton").click()
                page.wait_for_timeout(250)
                page.screenshot(path=str(output_dir / "filter-editor.png"))
                page.locator('.config-section-tab[data-config-section="app"]').click()
                page.wait_for_timeout(350)
